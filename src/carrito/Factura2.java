...
public class Factura2 extends javax.swing.JFrame {
    ...
    private void jPanel12MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel12MousePressed
        ...
        JFileChooser jfile = new JFileChooser();//se crea este tipo de archivo
        ...
        try {
            ...
            PdfPTable tbl= new PdfPTable(3);//es el número de columnas
...
//            
    ...
    public void mostrarDetalle(){
        ...
        try{
            ...
            String sql="call procedure_vista_factura('"+metodos.obtenerUltimaFactura(metodos.getObtenerusuario())+"')";
